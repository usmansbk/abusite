...
export type EditEventInput = {
  ...
  endTime?: InputMaybe<Scalars['LocalEndTime']>;
...
export type Event = {
  ...
  endTime?: Maybe<Scalars['LocalEndTime']>;
  id: Scalars['ID'];
